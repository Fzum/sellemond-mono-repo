...
const description = `<p>I'm Fabian, a <span class="text-accent-dark decoration-accent-dark">Freelance Fullstack Java developer</span> passionate about software
  ...
  interface all the way back to the <span class="text-accent-dark decoration-accent-dark">database</span>.</p><br><p>My professional career started
  in 2017 while I was doing my <span class="text-accent-dark decoration-accent-dark">Bachelor Studies in IT and Telecommunication</span>. Since then,
